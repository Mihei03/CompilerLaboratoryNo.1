...
<body>
  ...
  <h2 id="lab1">Лабораторная работа №3: Разработка синтаксического анализатора (парсера)<h2>
  ...
  <img src="bin/Debug/net7.0-windows/Readme/compile.png" alt="Граф конечного автомата">
